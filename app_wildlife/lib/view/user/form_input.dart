...
class _MyFormInputState extends State<MyFormInput> {
  ...
  void _postAnimal() async {
    try {
      ...
      print('Posting Hewan: $postData');

      // Map<String, dynamic> apiResponse = await apiService.postAnimal(
      //   name: postData['name'],
      //   namalatin: postData['namalatin'],
      //   species: postData['species'],
      //   habitat: postData['habitat'],
      //   jumlahpopulasi: postData['jumlahpopulasi'],
      //   lokasipopulasi: postData['lokasipopulasi'],
